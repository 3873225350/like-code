...
export function applyConfigEnvironmentVariables(): void {
  ...
  // Also apply env vars from likecode's own settings file
  const likecodeSettings = getLikeCodeSettings()
  if (likecodeSettings.env && typeof likecodeSettings.env === 'object') {
    Object.assign(
      process.env,
      filterSettingsEnv(likecodeSettings.env as Record<string, string>),
    )
  }
